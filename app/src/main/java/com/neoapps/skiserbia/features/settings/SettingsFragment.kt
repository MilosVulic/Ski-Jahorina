...
class SettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.about.setOnClickListener {
            findNavController().navigate(com.neoapps.skiserbia.NavigationGraphDirections.actionAbout())
        }

        binding.helpCenter.setOnClickListener {
            findNavController().navigate(com.neoapps.skiserbia.NavigationGraphDirections.actionHelpCenter())
        }
